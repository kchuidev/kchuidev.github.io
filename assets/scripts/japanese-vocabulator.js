...
function showInstructions() {
  ...
  let instructions_list = "<img src='assets/images/japanese-vocabulator/instructions_list.png' class='instructions_images'>単語を登録してから、単語リストが生成します。リストの単語をクリックすると、その単語の情報と書き順が現れます。単語リストが今使っているブラウザーにたまっていますので、他のブラウザーでそのリストが見ることができません。単語リストを他のブラウザーに転送したいとき、エクスポート機能とインポート機能を使ってください。";
